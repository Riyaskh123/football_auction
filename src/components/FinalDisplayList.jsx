                ...
                {squads.map(({ team, players: squad }, teamIdx) => {
                    ...
                    return (
                        <div
                            ...
                            style={{
                                animationDelay: `${teamIdx * 1000}ms`
                            }}
                        >
                            ...
                            <div className="relative px-3 py-4 flex flex-col gap-1 max-h-[420px] overflow-y-auto no-scrollbar">
                                {squad.length === 0 ? (
                                    <p className="text-floodlight/30 text-sm py-6 text-center">
                                        No players yet
                                    </p>
                                ) : (
                                    squad.map((player, i) => (
                                        <div
                                            ...
                                            style={{
                                                animationDelay: `${teamIdx * 1000 + 250 + i * 300}ms`
                                            }}
                                        >
                                            <img
                                                src={player.photoUrl}
                        ...
                        {squads.map(
                            ({ team, players: squad }, teamIdx) => {
                                ...
                                return (
                                    <div
                                        key={`first-${team.id}`}
                                        className="relative rounded-[15px] bg-pitch-800/50 backdrop-blur-[2px] border border-pitch-line overflow-hidden min-w-[250px] max-w-[500px] w-[320px] shrink-0"
                                    >
                                        <div className="absolute -inset-1 rounded-[26px] bg-gradient-to-b from-gold/20 via-transparent to-transparent blur-xl opacity-60 pointer-events-none" />
                                            ...
                                            {squad.length === 0 ? (
                                                ...
                                                squad.map(
                                                    (player, i) => (
                                                        <div
                                                            key={player.id}
                                                            className="flex items-center gap-2 rounded-lg bg-pitch-950/60 border border-pitch-line/60 overflow-hidden"
                                                        >
                                                            <img
                                                                src={player.photoUrl}
                                                                alt={player.name}
